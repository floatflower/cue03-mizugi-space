...
export const generateTradeInfo = (data) => {
  return {
    ...
    Amt: 0,
    ItemDesc: "Online Service",
    CREDIT: 1,
    APPLEPAY: data.applepayEnabled ? 1 : 0,
    ANDROIDPAY: data.androidpayEnabled ? 1 : 0,
    SAMSUNGPAY: data.samsungpayEnabled ? 1 : 0,
    UNIONPAY: data.unionpayEnabled ? 1 : 0,
    WEBATM: data.webatmEnabled ? 1 : 0,
    VACC: data.vaccEnabled ? 1 : 0,
    CVS: data.cvsEnabled ? 1 : 0,
    BARCODE: data.barcodeEnabled ? 1 : 0,
    CreditRed: data.creditRedEnabled ? 1 : 0,
    CREDITAE: data.creditAEEnabled ? 1 : 0,
    LINEPAY: data.linepayEnabled ? 1 : 0,
    InstFlag: 0,
    ESUNWALLET: data.esunwalletEnabled ? 1 : 0,
    TAIWANPAY: data.taiwanpayEnabled ? 1 : 0,
    BITOPAY: data.bitopayEnabled ? 1 : 0,
    FULA: data.fulapayEnabled ? 1 : 0,
    EZPAY: data.ezpayEnabled ? 1 : 0,
